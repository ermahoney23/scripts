...
plink --bfile ${set_name_version} --update-sex  /nfs/DATA/${cohort}/GWAS/Genotyped/Cleaned/${set_name}/${set_name_version}_genotyped_final.fam 3  --update-name /home/clarklc/Programs/HRC_snps_nodups --make-bed --out  /nfs/DATA/${cohort}/GWAS/Imputed/Cleaned/${set_name}/QC/${set_name_version}_names
